...
const ChatInputArea: React.FC<ChatInputAreaProps> = ({
  ...
  const suggestions = ["Spør meg om returvilkårene for denne varen...", "Spør meg om materialbruk og teknologier i dette produktet...", "Spør meg om bærekraft i produksjonen av denne varen...", "Spør meg om størrelsesanbefalinger for dette produktet...", "Spør meg om vedlikeholdstips for denne varen...", "Spør meg om garanti og reklamasjonsrettigheter for dette produktet..."];
  useEffect(() => {

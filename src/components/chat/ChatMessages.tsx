        ...
        return (
          <div 
            ...
            className={`px-4 py-3 rounded-xl relative ${
              message.type === 'user' 
                ? 'chat-message-user mr-auto bg-gray-200 shadow-sm border border-transparent inline-block max-w-[85%] w-auto' 
                : 'chat-message-agent ml-auto shadow-sm bg-gray-50 border border-transparent max-w-[85%]'
